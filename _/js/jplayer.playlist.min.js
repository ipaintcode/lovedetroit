...
(function(b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function(a) {
            var c = this,
                d = "<li><div>";
			d += "<div class='album-cover' style='background: url("+a.poster+") 0 "+(a.albumID)*70+"px;'></div>"
        ...
        _createItemHandlers: function(a) {
            var a = this;
            b(this.cssSelector.playlist + " a." + this.options.playlistOptions.itemClass).die("click").live("click", function() {
				...
				var eleString = ".artist-"+(a.current+1);
				...
				$('li.album-art').stop().animate({
				  ...
				  'background-position-y': ((a.current+1)*70)*-1+"px"
				}, 500);
        ...
        next: function() {
			...
			if(a > 0) {
				...
				$('li.album-art').stop().animate({
				  'background-position-x': '0',
				  'background-position-y': ((a+1)*70)*-1+"px"
				}, 500);
			}	
		},
        previous: function() {
